...
namespace Jigsaw.Data.Northwind
{
  ...
  public class Customer : ISaveable {
    ...
    [Display(Name = "Company Name", Description = "The Company Name")]
    public string CompanyName { get; set; }

    [MaxLength(30)]
    [Display(Name = "Contact Name", Description="Full Name of the customer")]
    public string ContactName { get; set; }

    [MaxLength(30)]
    [Display(Name = "Contact Title", Description="Contact Title")]
    public string ContactTitle { get; set; }


    [Display(Description = "Address not including the city and country.")]
    [MaxLength(60)]
    ...
    [Display(Description = "Last known phone.")]
    [MaxLength(24)]
