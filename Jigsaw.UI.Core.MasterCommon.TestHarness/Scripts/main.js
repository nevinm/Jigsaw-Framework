...
(function () {
    ...
    */
    ...
    require(['boot', 'Core/global-error-catching'], function (boot, GlobalErrorCatching) {
    ...
    */
    function initializeGlobalErrorCatching(GlobalErrorCatching) {
        ...
        var globalErrorCatching = new GlobalErrorCatching.ErrorModule(MessageQueue, Messages);
    }
