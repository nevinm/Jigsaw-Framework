...
{
    public class FormBuilderSection
    {
        private FormTemplatesCollectionSection frmTmpltCollSec;
        
        public FormTemplatesCollectionSection FrmTmpltCollSec
        {
            get { return frmTmpltCollSec; }
            set { frmTmpltCollSec = value; }
        }


        public FormBuilderSection(IWebDriver drvArg, IWait<IWebDriver> waitArg, int threadSleepTimeArg, By by)
        {
        ...
        } // end of public FormBuilderSection(IWebDriver drvArg, bool shouldItBeMax, Uri urlArg, IWait<IWebDriver> waitArg, int threadSleepTime)
    ...
    }  // end of public class FormBuilderSection
