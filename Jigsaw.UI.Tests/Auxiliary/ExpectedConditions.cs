...
namespace OpenQA.Selenium.Support.UI
{
    ...
    public sealed class ExpectedConditions
    {
        ...
        public static Func<IWebDriver, bool> DoesElementExist(By locator)
        {
            ...
            return (driver) =>
            {
                try
                {
                    return null != driver.FindElement(locator) ? true : false;
                }
                catch (NoSuchElementException)
                {
                    return false;
        ...
        public static Func<IWebDriver, bool> DoesElementNotExist(By locator)
        {
        ...
        public static Func<IWebDriver, bool> ElementIsClickable(By locator)
        {
            return driver =>
            {
        ...
        } // end of public static Func<IWebDriver, bool> ElementIsClickable( By locator)

        public static Func<IWebDriver, bool> ElementIsNotClickable(By locator)
        {
            return driver =>
            {
                //    var element = driver.FindElement(locator);
                ...
                {
                    var element = driver.FindElement(locator);
                    if (element == null && (false == element.Displayed) && (false == element.Enabled))
                    {
                        return true;
                    }
                    return false;
