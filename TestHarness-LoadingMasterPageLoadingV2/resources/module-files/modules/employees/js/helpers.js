    ...
    (function (employees) {
        ...
        var DataPopup = (function () {
            ...
            DataPopup.prototype.show = function (entity, dataSource, options) {
                var selectedTemplate = options && options.readOnly ? this.readOnlyTemplate : this.template, view = _data.Templates.PopupLayout(selectedTemplate), window = new _app.Views.WindowView(view, { close: close, size: _app.Views.WindowSize.LARGE }), viewModel = new _data.DataPopupViewModel(entity, dataSource, window, {
