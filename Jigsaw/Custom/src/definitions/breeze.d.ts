...
declare module breeze {
    ...
    class EntityManager {
        ...
        attachEntity(entity: Entity, entityState?: EntityStateSymbol, mergeStrategy?: StrategySymbol): Entity;
        clear(): void;
    ...
    class MetadataStore {
        ...
        importMetadata(exportedString: string, merge?:boolean): MetadataStore;
        isEmpty(): boolean;
